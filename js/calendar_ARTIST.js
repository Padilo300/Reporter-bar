$( document ).ready(function() {
    ...
    function getSchedule_user_1() {
        ...
        function(data) {
            $('#Wrap_Calendar_ARTIST .fact-row-1 .dayGrid').remove(); //удалить старую сетку рабочих дней
    ...
    function getSchedule_user_2() {
        ...
        function(data) {
            $('#Wrap_Calendar_ARTIST .fact-row-2 .dayGrid').remove(); //удалить старую сетку рабочих дней
            //получает ответ JSON массив true для рабочих ней и false для выходных
            data = $.parseJSON(data);
            for (var i = 0, d = 1, a = 1; i < dInMonth(Month,Year); i++) {
                if (data[i] === 'true') {   
    ...
    function getSchedule_user_3() {
        ...
        function(data) {
            $('#Wrap_Calendar_ARTIST .fact-row-3 .dayGrid').remove(); //удалить старую сетку рабочих дней
            //получает ответ JSON массив true для рабочих ней и false для выходных
            data = $.parseJSON(data);
            for (var i = 0, d = 1, a = 1; i < dInMonth(Month,Year); i++) {
                if (data[i] === 'true') {   
    ...
    function getSchedule_user_4() {
        ...
        function(data) {
            $('#Wrap_Calendar_ARTIST .fact-row-4 .dayGrid').remove(); //удалить старую сетку рабочих дней
            //получает ответ JSON массив true для рабочих ней и false для выходных
            data = $.parseJSON(data);
            for (var i = 0, d = 1, a = 1; i < dInMonth(Month,Year); i++) {
                if (data[i] === 'true') {   
    ...
    function getSchedule_user_5() {
        ...
        function(data) {
            $('#Wrap_Calendar_ARTIST .fact-row-5 .dayGrid').remove(); //удалить старую сетку рабочих дней
            //получает ответ JSON массив true для рабочих ней и false для выходных
            data = $.parseJSON(data);
            for (var i = 0, d = 1, a = 1; i < dInMonth(Month,Year); i++) {
                if (data[i] === 'true') {   
    ...
    function getSchedule_user_6() {
        ...
        function(data) {
            $('#Wrap_Calendar_ARTIST .fact-row-6 .dayGrid').remove(); //удалить старую сетку рабочих дней
            //получает ответ JSON массив true для рабочих ней и false для выходных
            data = $.parseJSON(data);
            for (var i = 0, d = 1, a = 1; i < dInMonth(Month,Year); i++) {
                if (data[i] === 'true') {   
